...
public class AESCodec {
	...
	public static String encrypt(String data, String key) {
		try {
			...
			return Base64.encodeBase64String(cipher.doFinal(data.getBytes("UTF-8"))); // 执行加密操作。加密后的结果通常都会用Base64编码进行传输
		} catch (Exception e) {
			JOptionPane.showMessageDialog(null, "程序出错，将自动退出！");
			System.exit(1);
			return "";
		}
	}
	...
	public static void main(String[] args) throws Exception {
		...
		String key = initkey(); // example key: yETWedDzLh377ZBfQpwoSQ==
